...
public class ChainPunches : IComboRule
{
    private ComboActionCommandFactory _comboActionCommandFactory;

    public int ComboLength { get; private set; }

    public ChainPunches(ComboActionCommandFactory actionCommandFactory)
    {
    ...
    public bool IsMatch(IEnumerable<ICombatCommand> sequence)
    {
        ...
        return first is HighAttackCommand && second is HighAttackCommand && third is HighAttackCommand  && fourth is HighAttackCommand && fifth is HighAttackCommand;
    }
