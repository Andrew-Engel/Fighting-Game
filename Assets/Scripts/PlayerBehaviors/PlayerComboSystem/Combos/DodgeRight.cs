...
public class DodgeRight : IComboRule
{
    private ComboActionCommandFactory _comboActionCommandFactory;

    public int ComboLength { get; private set; }

    public DodgeRight(ComboActionCommandFactory actionCommandFactory)
    {
    ...
    {
        return firstCommand is RightInputCommand;
    }
    ...
    public bool IsMatch(IEnumerable<ICombatCommand> sequence)
    {
        ...
        return first is RightInputCommand && second is RightInputCommand;
    }
    ...
    {
        return _comboActionCommandFactory.CreateNewDodgeRightCommand();
    }
}
