...
namespace Tutorial.PatternCombo
{
    ...
    public class ComboActionQueueManager: MonoBehaviour
    {
        ...
        public void AddCommandToComboSequence(ICombatCommand command)
        {
        ...
        private void EnqueueCommandAndResetTimers(ICombatCommand command)
        {
        ...
        public Queue<ICombatCommand> GetComboSequence()
        {
